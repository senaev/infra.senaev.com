        ...
        messages: [
            {
                ...
                content: [
                    ...
                    "Return the task description in the task field. Keep the wording as close to the original message as possible — do not rephrase or rewrite unless necessary.",
        ...
        messages: [
            {
                ...
                content: [
                    ...
                    "## Task",
                    "Copy the message into the task field as-is, only making the minimal changes needed to form a valid task description. Do not rephrase or rewrite.",
                    "If the message mentions a due date or deadline, extract it as due_date in YYYY-MM-DD format; otherwise set due_date to null.",
                    "Answer strictly in JSON that matches the provided schema.",
